var v = new Vue({
    ...
    created:function() {
        ...
        $.ajax({
            type:"get",
            url:ajaxurl()+"/activle/list.aspx?pageIndex="+that.pageIndex+"&pageSize="+that.pageSize+"&Title=%E6%96%87%E7%AB%A0%E9%9B%86%E9%94%A6",
    ...
    methods: {
        ...
        articleDet:function(id){
        	window.location.href = "articleDet.html?id="+id
        },
          onPullingUp:function() {
            ...
            if(that.upTrue){
                that.$refs.scroll.forceUpdate();
                 ...
                 $.ajax({
                    type:"get",
                    url:ajaxurl()+"/activle/list.aspx?pageIndex="+that.pageIndex+"&pageSize=10&Title=%E6%96%87%E7%AB%A0%E9%9B%86%E9%94%A6",
                    success:function(data){
                        var datas = json1(data);
