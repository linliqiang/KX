...
var v = new Vue({
    ...
    created:function() {
        ...
        $.ajax({
            type:"get",
            url:ajaxurl()+"/activle/list.aspx?pageIndex="+that.pageIndex+"&pageSize="+that.pageSize+"&Title="+"指南共识",
    ...
    methods: {
        ...
        guideDet:function(id){
            window.location.href = "guideDet.html?id="+id
        },
        onPullingUp:function() {
            ...
            if(that.upTrue){
                that.$refs.scroll.forceUpdate();
                 ...
                 $.ajax({
                    type:"get",
                    url:ajaxurl()+"/activle/list.aspx?pageIndex="+that.pageIndex+"&pageSize=10&Title="+"指南共识",
                    success:function(data){
                        var datas = json1(data);
